...
parser.add_argument('-g', dest='krakengenome',help="Kraken identified genome (Snakemake wildcard!)",type=str)
...
def merge_fq(ls_sample_file,subject,genome):
    ...
    outfile1 = "../kraken2/0-tmp/in1_spades_"+subject+"_"+genome+".fq.gz"
    outfile2 = "../kraken2/0-tmp/in2_spades_"+subject+"_"+genome+".fq.gz"
...
def run_spades(executable_spades,ls_merge_fq, subject, genome, threads):
    ''' run spades. output to 3-spades/subject_[]/ '''
    outfolder = "3-spades/subject_"+subject+"_"+genome+"/"
...
if __name__ == "__main__":
    ...
    kraken_genome = args.krakengenome
    threads = args.threads
    executable_spades = args.exeSpades
    outfileLs = merge_fq(file_names,subjectID,kraken_genome)
    run_spades(executable_spades,outfileLs,subjectID,kraken_genome,threads)
    sys.exit()
